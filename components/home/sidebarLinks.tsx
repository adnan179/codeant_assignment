...
const SidebarLinks: React.FC = () => {
  ...
  const links = [
    { id: "home", label: "Repositories", icon: homeIcon, icon2: homeIcon2 },
    { id: "code", label: "AI Code Review", icon: codeIcon, icon2: codeIcon2 },
    { id: "cloud", label: "Cloud Security", icon: cloudIcon, icon2: cloudIcon2 },
    { id: "how to use", label: "How to Use", icon: bookIcon, icon2: bookIcon2 },
    { id: "settings", label: "Settings", icon: settingsIcon, icon2: settingsIcon2 },
  ];
